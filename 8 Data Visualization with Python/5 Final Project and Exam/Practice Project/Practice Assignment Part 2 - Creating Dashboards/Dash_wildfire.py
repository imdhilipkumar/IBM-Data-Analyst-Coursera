...
app.layout = html.Div(children=[
    ...
    html.Div([
        ...
        # First Inner Division: Region Selection
        html.Div([
        ...
        # Second Inner Division: Output Graphs
        html.Div([
            html.Div([], id='plot1', style={'width': '48%', 'display': 'inline-block'}),
            html.Div([], id='plot2', style={'width': '48%', 'display': 'inline-block'})
